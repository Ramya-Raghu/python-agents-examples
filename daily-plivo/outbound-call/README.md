# Daily Plivo Outbound Call Example

This example demonstrates how to initiate outbound phone calls using Plivo and Daily, with an AI bot handling the conversation.
...
4. Bot joins Daily room via WebRTC
   ↓
5. Server uses Plivo API to initiate call to target phone number
   ↓
6. Plivo connects call to Daily's SIP endpoint via webhook
   ↓
